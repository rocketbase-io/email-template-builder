...
<Tabs syncKey="buildtool">
	...
	<TabItem label="Gradle">
		```kotlin
		implementation("io.rocketbase.mail:email-template-builder:2.7.0")
		```
	</TabItem>
</Tabs>
...
- Explore all content blocks in the [Builder API](/email-template-builder/builder-api/)
- Adjust colors, widths and layout via [Configuration](/email-template-builder/configuration/)
- See complete, rendered [Examples](/email-template-builder/examples/)
